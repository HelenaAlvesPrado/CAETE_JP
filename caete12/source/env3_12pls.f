...
c ph1, ph2, ph3,ph4, ph5, ph6 , ph7
      real, dimension(nx,ny,12) :: ar
c ar1, ar2, ar3, ar4, ar5, ar6, ar7
      real, dimension(nx,ny,12) :: npp
c npp1,npp2,npp3,npp4,npp5,npp6,npp7
      real, dimension(nx,ny,12) :: lai
c lai1, lai2, lai3,lai4, lai5,lai6, lai7
      real, dimension(nx,ny,12) :: clit
c clit1, clit2, clit3, clit4,clit5, clit6, clit7
      real, dimension(nx,ny,12) :: csoil
c csoil1, csoil2, csoil3, csoil4 , csoil5, csoil6, csoil7
      real, dimension(nx,ny,12) :: hr
c hr1, hr2, hr3, hr4, hr5, hr6, hr7
      real, dimension(nx,ny,12) :: rcm
c, rcm1, rcm2, rcm3 , rcm4, rcm5,rcm6, rcm7
      real, dimension(nx,ny,12) :: evaptr
c et1, et2, et3 c, et4, et5, et6, et7
...
!     PFT       1       2       3       4       5       6       7
      data dt3/0.30,   0.35,   0.35,   0.30,   0.45,   0.30,   0.35, !aleaf
     &
!           8       9       10      11      12
     &    0.45,   0.35,   0.40,   0.30,   0.35/
!     PFT       1       2       3       4       5       6       7
...
!     PFT       1       2       3       4       5       6       7
      data dt5/0.35,   0.30,   0.45,   0.45,   0.55,   0.35,   0.25, !afroot
     &
!           8       9       10      11      12
     &    0.55,   0.45,   0.40,   0.30,   0.30/
!     PFT       1       2       3       4       5       6       7
      data dt6/6.0,    2.0,    2.0,    5.0,    3.0,    6.0,    3.0, !tleaf
     &
!          8       9       10      11      12
     &    2.0,    1.0,    3.0,    8.3,    4.0/
!     PFT       1       2       3       4       5       6       7
      data dt7/30.0,   30.0,   20.0,   20.0,   0.0,    50.0,   50.0, !tawood
     &
!          8       9       10      11      12
