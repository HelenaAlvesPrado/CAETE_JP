...
real, dimension(nx,ny,12) :: prec, temp,wsoil, wsoil2, par, photo, aresp,&
                             npp, lai, clit, csoil, hresp,gsoil,ssoil,snowm,&
                             runom, evapm, emaxm, rcm, wg0, tsoil

real, dimension(nx,ny) :: lsmk ,p0 ,tmin ,seanpp, meanpp, meanhr, meancs,&
                          mphoto, maresp, ave_wsoil, ave_evap, ave_rc,&
                          nppmin, nppmax, meant, seat
...
do i=1,nx
    do j=1,ny
        if ((mod(j,ny) == 0).and.(mod(i,10) == 0)) write(*,*) 'water balance:',i
