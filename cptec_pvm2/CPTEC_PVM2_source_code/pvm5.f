...
c      open(18,file='../outputs/npp.flt',
c    &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(18,rec=1) auxnpp
c      close(18)
c
c      open(19,file='../outputs/snpp.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(19,rec=1) auxsnpp
c      close(19)
c
c      open(20,file='../outputs/hresp.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(20,rec=1) auxhresp
c      close(20)
cc
c      open(21,file='../outputs/csoil.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(21,rec=1) auxcsoil
c      close(21)
cc
c      open(22,file='../outputs/photo.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(22,rec=1) auxphoto
c      close(22)
cc
c      open(23,file='../outputs/aresp.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(23,rec=1) auxaresp
c      close(23)
cc
c      open(24,file='../outputs/wsoil.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(24,rec=1) auxwsoil
c      close(24)
cc
c      open(25,file='../outputs/ave_evap.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(25,rec=1) auxevap
c      close(25)
cc
c      open(26,file='../outputs/ave_rc.flt',
c     &        status='unknown',form='unformatted',
c     &        access='direct',recl=4*nx*ny)
c      write(26,rec=1) auxrc
c      close(26)
c
      stop
      end
