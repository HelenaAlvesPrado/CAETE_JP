...
c=====================================================================
      ...
      subroutine allocation (npp,cl1,ca1,cf1,cb1,cs1,cr1,co1,i6,
     &                      alc_leaf,alc_froot,alc_awood,
     &                       cl2,ca2,cf2,cb2,cs2,cr2,co2)   !output
c
c
!     variables
	     parameter(mal=80,maf=80,maw=80,mtl=2)
	     integer i6,i1,i2,i3,i4   !index for calculate the 3 PFTs (i6.eq.1 - TBE; i6.eq.2 - TBD; i6.eq.3 - HERB)
     ...
     &		 alc_awood(mal,maf,maw),tur_leaf(mal,maf,maw)
...
c=====================================================================
c
 ! próximo passo, verificar em a e c       print*,i6, i1,i2,i3,i4
c
...
c initialization
	             ...
	             do i1 = 20,80,40 !e.g. C-leaf
		          ...
		          cl2 = (((alc_leaf(i1,i2,i3)/100)*npp_aux) - 
     &				  (cl1/((tleaf(i6))*365)))+ cl1
	              cf2 = (((alc_froot(i1,i2,i3)/100)*npp_aux) - 
     &				  (cf1/((tfroot(i6))*365)))+ cf1
	              ca2 = (((alc_awood(i1,i2,i3)/100)*npp_aux) - 
