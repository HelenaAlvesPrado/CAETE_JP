...
c     new vRIABLWA
C     cleaf_pft(nx,ny,12,npls)
C     cawood_pft(nx,ny,12,npls)
C     cbwood_pft(nx,ny,12,npls)
C     cfroot_pft(nx,ny,12,npls)
C     csto_pft(nx,ny,12,npls)
C     crep_pft(nx,ny,12,npls
C     cother_pft(nx,ny,12,npls)
