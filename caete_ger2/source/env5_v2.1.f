...
!     calling spinup
     ...
     &              ,smin,prann)
                ...
                do p=1,q   
                   cleafin(i,j,p)  = aux1(p) ! initial pool C mass kg m-2 
...
c                  csoil4(i,j,k) = csoil_pft(i,j,k,4)
c                  csoil5(i,j,k) = csoil_pft(i,j,k,5)
c                  csoil6(i,j,k) = csoil_pft(i,j,k,6)
c                  csoil7(i,j,k) = csoil_pft(i,j,k,7)
c
c                  et1(i,j,k) = evapm_pft(i,j,k,1)
c                  et2(i,j,k) = evapm_pft(i,j,k,2)
c                  et3(i,j,k) = evapm_pft(i,j,k,3)
c                  et4(i,j,k) = evapm_pft(i,j,k,4)
c                  et5(i,j,k) = evapm_pft(i,j,k,5)
c                  et6(i,j,k) = evapm_pft(i,j,k,6)
c                  et7(i,j,k) = evapm_pft(i,j,k,7)
c                  
c                  rcm1(i,j,k) = rcm_pft(i,j,k,1)
c                  rcm2(i,j,k) = rcm_pft(i,j,k,2)
c                  rcm3(i,j,k) = rcm_pft(i,j,k,3)
c                  rcm4(i,j,k) = rcm_pft(i,j,k,4)
c                  rcm5(i,j,k) = rcm_pft(i,j,k,5)
c                  rcm6(i,j,k) = rcm_pft(i,j,k,6)
...
c      open(10,file='../outputs_pft/npp.4.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, npp4)
c      open(10,file='../outputs_pft/npp.5.bin',
c     &     status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, npp5)
c      open(10,file='../outputs_pft/npp.6.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, npp6)
...
c      open(10,file='../outputs_pft/ph.4.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, ph4)
c      open(10,file='../outputs_pft/ph.5.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, ph5)
c      open(10,file='../outputs_pft/ph.6.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, ph6)
...
c      open(10,file='../outputs_pft/ar.4.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, ar4)
c      open(10,file='../outputs_pft/ar.5.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, ar5)
c      open(10,file='../outputs_pft/ar.6.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, ar6)
...
c      open(10,file='../outputs_pft/hr.4.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, hr4)
c      open(10,file='../outputs_pft/hr.5.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, hr5)
c      open(10,file='../outputs_pft/hr.6.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, hr6)
...
c      open(10,file='../outputs_pft/clit.4.bin',
c     &     status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, clit4)
c      open(10,file='../outputs_pft/clit.5.bin',
c     &     status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, clit5)
c      open(10,file='../outputs_pft/clit.6.bin',
c     &     status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, clit6)
...
c      open(10,file='../outputs_pft/csoil.4.bin',
c     &     status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, csoil4)
c      open(10,file='../outputs_pft/csoil.5.bin',
c     &     status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, csoil5)
c      open(10,file='../outputs_pft/csoil.6.bin',
c     &     status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, csoil6)
...
c      open(10,file='../outputs_pft/et.4.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, et4)
c      open(10,file='../outputs_pft/et.5.bin',
c     &     status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, et5)
c      open(10,file='../outputs_pft/et.6.bin',
c     &    status='unknown',form='unformatted',
c     &     access='direct',recl=4*nx*ny)
c      call save_file12(10, et6)
...
c      open(10,file='../outputs_pft/rcm.4.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, rcm4)
c      open(10,file='../outputs_pft/rcm.5.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, rcm5)
c      open(10,file='../outputs_pft/rcm.6.bin',
c     &    status='unknown',form='unformatted',
c     &    access='direct',recl=4*nx*ny)
c      call save_file12(10, rcm6)
...
!     PFT         1       2       3       4       5       6       7      
      ...
      data dt2/5.9E-5, 3.4E-5, 3.3E-5, 3.1E-5, 3.1E-5, 3.0E-5, 3.5E-5/  !p21
      ...
      data dt6/6.0,    6.5,    8.3,     3.5,    3.8,    3.8,   6.0/     !tleaf
      data dt7/50.,    38.0,   35.6,    4.0,    0.0,    0.0,    42.5/   !tawood
...
!     leaves/fine roots/ sapwood N to C Ratio
      data dt15/3e-2, 2.8e-2,  4e-2,   4e-2,   4e-2,   4e-2,   3e-2/  !ncl 
      data dt16/2.3e-2,2.3e-2,2.3e-2,  2.3e-2, 2.3e-2, 2.3e-2, 2.3e-2/    !ncf
      data dt17/2e-3,  2e-3,   2e-3,   2e-3,   0.0,    0.0,    2e-3/    !ncs
...
!     INTERNAL VARS
      ...
      do i6=1,npfts
C         if(( tl .gt. tmin(i6) .and. (th .le. tmax(i6)))
C     &       .and.
C     >    
C     &       (ul .gt. rhmin(i6)) .and.
C     &       (s  .le. snpp(i6))  .and.
C     &       (pm .ge. precm(i6)) .or. .true.
C     &       ) then
c            print*, 'pft allowed'
            do k=1,nt
               if (k.eq.1) then
...
C         else ! pft don't populate this cell
C            cleafini(i6) = 0.0
C            cleafini(i6) = 0.0
C            cleafini(i6) = 0.0
C         endif
      enddo                     ! npfts 
c      call pft_area_frac(cleafini, cfrootini, cawoodini, ocp, inutil)
c      do i6 = 1,npfts
