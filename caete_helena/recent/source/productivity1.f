...
!=============================================================================================
!
      subroutine productivity1 (temp,p0,w,wmax,ca,ipar,l, !Inputs
...
!     
      ...
      vm = (p21(l)*p22**(p10*(temp-p11)))/ !Free-range parameter --> 0.0358>vm>840 (micromol)
...
!     ------------------------------------------
!     
      f4 = (1.0-(exp(-p26*laia)))/p26 !Sun 90� in the whole canopy, to be used for respiration
!     
!     Sun/Shade approach to canopy scaling                                  !Based in de Pury & Farquhar (1997)
!     ------------------------------------
!     
      f4sun = (1.0-(exp(-p26*sunlai)))/p26 !sun 90�
      f4shade = (1.0-(exp(-p27*shadelai)))/p27 !sun ~20�
!     
...
!     ----------------------------------
!     
      rl = 0.012*31557600.0*p30*vm*f4*f5 !Leaf respiration
!     
      rp = p31*rl               !Non-leaf parts respiration
!     
