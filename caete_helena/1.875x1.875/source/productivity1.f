...
!     ------------------
!     
      real vm,mgama,es,rmax,r,ci,a,b,c,a2,b2,c2,delta,delta2,f1,f1a,f2
     $     ,f3,f4,f5,k16,k17,rl,rp
...
!     Parameters
!     ----------
      real p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17
     $     ,p18,p19,p20,p22,p23,p24,p25,p26,p27,p28,p29,p30,p31
      real p21(3)
!     
...
!     
!     
!     Tropical Evergreen Tree (angiosperm)               0.5
!     3.5 (n=6)
!     Temperate Deciduous Tree (angiosperm)              0.5
!     4,4 (n=16)
!     Boreal Deciduous Tree (angiosperm)                 0.5
!     2.7 (n=1)
!     
      return
      end
